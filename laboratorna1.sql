...
--
-- Хост: localhost
-- Время создания: Мар 29 2022 г., 21:47
...
INSERT INTO `book` (`ID`, `COD`, `NEW`, `NAME`, `COST`, `PUBLISH`, `PAGES`, `FORMAT`, `DAT`, `DRAW`, `THEME`, `CATEGORY`) VALUES
(2, 5110, 'No', 'Апаратні засоби мультимедіа. Відеосистема РС', '$15.51', 'Видавнича група BHV', 400, '70х100/16', '07/24/2000', 5000, 'Використання ПК в цілому', 'Підручники'),
...
(9, 5141, 'No', 'Структури даних та алгоритми', '$37.80', 'Вільямс', 384, '70х100/16', '9/29/2000', 5000, '	\r\nВикористання ПК в цілому', 'Підручники'),
...
(31, 5110, 'No', 'Апаратні засоби мультимедіа. Відеосистема РС', '$15.51', 'Видавнича група BHV', 400, '70х100/16', '07/24/2000', 5000, 'Використання ПК в цілому', 'Апаратні засоби ПК'),
(46, 5199, 'No', 'Залізо IBM 2001', '$30.07', 'МикроАрт', 368, '70х100/16', '12/02/2000', 5000, 'Використання ПК в цілому', 'Апаратні засоби ПК'),
(50, 3851, 'No', 'Захист інформації та безпека компютерних систем', '$26.00', 'DiaSoft', 480, '84х108/16', 'NULL', 5000, 'Використання ПК в цілому', 'Захист і безпека ПК'),
...
(191, 860, 'No', 'Операційна система UNIX', '$3.50', ' Видавнича група BHV', 395, '84х10016', '05/05/1997', 5000, 'Операційні системи', 'Unix'),
...
(206, 5176, 'No', 'Windows Ме. Супутник користувача', '$12.79', 'Видавнича група BHV', 306, '', '10/10/2000', 5000, 'Операційні системи', 'Інші операційні системи'),
...
(222, 235, 'No', 'Інформаційні системи і структури даних', '', 'Києво-Могилянська академія', 288, '60х90/16', NULL, 400, 'Використання ПК в цілому', 'Інші книги'),
(225, 8746, 'Yes', 'Бази даних в інформаційних системах', '', 'Університет \"Україна\"', 418, '60х84/16', '25/07/2018', 100, 'Програмування', 'SQL'),
(226, 2154, 'Yes', 'Сервер на основі операційної системи FreeBSD 6.1', '', 'Університет \"Україна\"', 216, '60х84/16', '03/11/2015', 500, 'Програмування', 'Інші операційні системи'),
(245, 2662, 'No', 'Організація баз даних та знань', '', 'Вінниця: ВДТУ', 208, '60х90/16', '10/10/2001', 1000, 'Програмування', 'SQL'),
(247, 5641, 'Yes', 'Організація баз даних та знань', '', 'Видавнича група BHV', 384, '70х100/16', '15/12/2021', 5000, 'Програмування', 'SQL');
